...
agent_communication:
  ...
  - agent: "testing"
    message: |
      ...
      Backend URL: https://amazing-bartik.preview.emergentagent.com/api
  - agent: "testing"
    message: |
  ...
  - agent: "main"
    message: |
      ...
      Testing frontend with backend URL: https://amazing-bartik.preview.emergentagent.com/api
  - agent: "main"
    message: |
  ...
  - agent: "testing"
    message: |
      ...
      **Production-Grade Security:**
      ...
      - ✅ Backend URL accessible: https://amazing-bartik.preview.emergentagent.com/api
