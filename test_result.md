...
agent_communication:
  ...
  - agent: "testing"
    message: |
      ...
      Backend URL: https://dynamofix.preview.emergentagent.com/api
  - agent: "testing"
    message: |
  ...
  - agent: "main"
    message: |
      ...
      Testing frontend with backend URL: https://dynamofix.preview.emergentagent.com/api
  - agent: "main"
    message: |
  ...
  - agent: "testing"
    message: |
      ...
      **Production-Grade Security:**
      ...
      - ✅ Backend URL accessible: https://dynamofix.preview.emergentagent.com/api
