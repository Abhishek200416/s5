...
agent_communication:
  ...
  - agent: "testing"
    message: |
      ...
      Backend URL: https://alert-whisperer.preview.emergentagent.com/api
  - agent: "testing"
    message: |
  ...
  - agent: "main"
    message: |
      ...
      Testing frontend with backend URL: https://alert-whisperer.preview.emergentagent.com/api
  - agent: "main"
    message: |
  ...
  - agent: "testing"
    message: |
      ...
      **Production-Grade Security:**
      ...
      - ✅ Backend URL accessible: https://alert-whisperer.preview.emergentagent.com/api
